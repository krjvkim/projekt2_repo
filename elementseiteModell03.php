                ...
                <div class="card">
                    ...
                    <div class="card-description">
                        ...
                        <p>
                            ...
                            $tabelle = 'elemente';
                            $datei = 'elementseiteModell03.php'; 
    
                            $query = "SELECT id, teiletyp, fertigungsdatum, fertigungsdienstleister FROM elemente WHERE id = '10010103'";
                        ...
                        <p>
                            <?php
                            $query = "SELECT anbringungnfctag, uidtag, leitung, anschluss FROM elemente WHERE id = '10010103'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        ...
                        <p>
                            <?php
                            $query = "SELECT holzelement, daemmstoff, beleuchtung, schrauben FROM elemente WHERE id = '10010103'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        ...
                        <p>
                            <?php
                            $query = "SELECT fenster, tuere, baulicheveraenderungen, modulid FROM elemente WHERE id = '10010103'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
