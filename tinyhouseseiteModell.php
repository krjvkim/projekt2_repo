...
<head>
    ...
    <title>
        Smart Factory Show Room - Tinyhouse
    </title>
</head>
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Tiny House Modell</h2>
        <div id="post-container">
            <section id="blogpost">
                <div class="card">
                    <div class="card-image">
                        <img src="img/tinyhousemodell.jpeg" alt="Card Image">
                    </div>
                    <div class="card-description">
                        <h3>Tinyhouseinformationen</h3>
                        <p>
                        <?php
                            $host = "localhost";
                            $user = "postgres";
                            ...
                            $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Tiny House Modell'";
                        ...
                        <p>
                        <?php
                        $query = "SELECT id, bezeichnung, baudatum, eigentuemer, siedlungid FROM tinyhouses WHERE bezeichnung = 'Tiny House Modell'";
                        $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        echo "<thead>"; echo "<tr>"; echo "<th>Tiny House-ID</th>"; echo "<th>Bezeichnung</th>"; echo "<th>Baudatum</th>"; echo "<th>Eigentümer</th>"; echo "<th>Siedlung-ID</th>"; echo "</tr>"; echo"</thead>";
                        while ($row=pg_fetch_row($result))
                        {
                            echo "<tr>";
                            foreach ($row as $item)    // jedes Element $item der Zeile $row durchlaufen
            ...
            <footer id="sidebar">
            <div id="sidebar">
                <h3> Weiter zu den Modulen dieses Tinyhouses</h3>
                <p>
                    <ul>
                        <li>
                            <a href="modulseiteEingang.php">Modul "Eingang"</a>
                        </li>
                        <li>
                            <a href="modulseiteSeminar.php">Modul "Seminarraum"</a>
                        </li>
                        
                        <li>
                            <a href="siedlungseiteGP.php">Zurück zur Siedlung Göppingen</a>
                        </li>
                    </ul>
                </p>
                    </div>
