...
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Gestell 2</h2>
        <div id="post-container">
            <section id="blogpost">
                <div class="card">
                    <div class="card-image">
                        <img src="img/elementgestell2.jpeg" alt="Card Image">
                    </div>
                    <div class="card-description">
                        ...
                        <p>
                            ...
                            $tabelle = 'elemente';
                            $datei = 'elementseiteModell10.php'; 
    
                            $query = "SELECT id, teiletyp, fertigungsdatum, fertigungsdienstleister FROM elemente WHERE id = '10010206'";
                        ...
                        <p>
                            <?php
                            $query = "SELECT anbringungnfctag, uidtag, baulicheveraenderungen, modulid   FROM elemente WHERE id = '10010206'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        echo "<thead>"; echo "<tr>"; echo "<th>Anbringung des NFC-Tags</th>"; echo "<th>UID-Tag</th>"; echo "<th>Bauliche Veränderungen und Material</th>"; echo "<th>Modul-ID</th>"; echo "</tr>"; echo"</thead>";
                        while ($row=pg_fetch_row($result))
                        {
                            echo "<tr>";
                            foreach ($row as $item)    // jedes Element $item der Zeile $row durchlaufen
