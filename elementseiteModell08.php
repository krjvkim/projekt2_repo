...
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Wand Fenster</h2>
        <div id="post-container">
            <section id="blogpost">
                <div class="card">
                    <div class="card-image">
                        <img src="img/elementwandfenster.jpeg" alt="Card Image">
                    </div>
                    <div class="card-description">
                        ...
                        <p>
                            ...
                            $tabelle = 'elemente';
                            $datei = 'elementseiteModell08.php'; 
    
                            $query = "SELECT id, teiletyp, fertigungsdatum, fertigungsdienstleister FROM elemente WHERE id = '10010203'";
                        ...
                        <p>
                            <?php
                            $query = "SELECT anbringungnfctag, uidtag, leitung, anschluss FROM elemente WHERE id = '10010203'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        ...
                        <p>
                            <?php
                            $query = "SELECT holzelement, daemmstoff, beleuchtung, schrauben FROM elemente WHERE id = '10010203'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        ...
                        <p>
                            <?php
                            $query = "SELECT fenster, tuere, baulicheveraenderungen, modulid FROM elemente WHERE id = '10010203'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
