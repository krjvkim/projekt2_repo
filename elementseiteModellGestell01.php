...
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Gestell 1</h2>
        <div id="post-container">
            <section id="blogpost">
                <div class="card">
                    <div class="card-image">
                        <img src="img/elementgestell1.jpeg" alt="Card Image">
                    </div>
                    <div class="card-description">
                        ...
                        <p>
                            ...
                            $query = "SELECT id, teiletyp, fertigungsdatum, fertigungsdienstleister FROM elemente WHERE id = '10010207'";
                        ...
                        <p>
                            <?php
                            $query = "SELECT anbringungnfctag, uidtag, baulicheveraenderungen, modulid   FROM elemente WHERE id = '10010207'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
