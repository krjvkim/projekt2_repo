...
<head>
    ...
    <title>
        Smart Factory Show Room - Tinyhousesiedlung
    </title>
</head>
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Tiny House-Siedlung Göppingen</h2>
        <div id="post-container">
            <section id="blogpost">
                <div class="card">
                    ...
                    <div class="card-description">
                        ...
                        <p>
                        <?php
                        $query = "SELECT id, siedlungsname, ort, plz, strasse, hausnummer, gruendungsdatum FROM siedlungen WHERE siedlungsname = 'Tiny House-Siedlung Göppingen'";
                        $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        echo "<thead>"; echo "<tr>"; echo "<th>Siedlung-ID</th>"; echo "<th>Siedlungsname</th>"; echo "<th>Ort</th>"; echo "<th>PLZ</th>"; echo "<th>Straße</th>"; echo "<th>Hausnummer</th>"; echo "<th>Gründungsdatum</th>"; echo "</tr>"; echo"</thead>";
                        while ($row=pg_fetch_row($result))
                        {
                            echo "<tr>";
                            foreach ($row as $item)    // jedes Element $item der Zeile $row durchlaufen
            ...
            <footer id="sidebar">
                <div id="sidebar">
                    <h3> Weiter zu den Tiny Houses dieser Siedlung</h3>
                    <p> 
                        <ul>
                            <li>
                                <a href="tinyhouseseiteModell.php">Tiny House Modell<br /></a>
                            </li>
                            
                            <li>
                                <a href="tinyhousesiedlungen.php">Zurück zu den Siedlungen</a>
                            </li>
