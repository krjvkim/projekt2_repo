...
<head>
    ...
    <title>
        Smart Factory Show Room - Das Bauteilkennzeichnungsprojekt
    </title>
</head>
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Das Bauteilkennzeichnungsprojekt</h2>
            ...
            <section id="blogpost">
                <div class="card">
                    ...
                    <div class="card-description">
                        ...
                        $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Das Bauteilkennzeichnungsprojekt'";
