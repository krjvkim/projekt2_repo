...
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Überschrift des Abschnitts</h2>
            ...
            <section id="blogpost">
                <div class="card">
                    ...
                    <div class="card-description">
                        ...
                        <p>
                            <?php
                            $query = "SELECT anbringungnfctag, uidtag, leitung, anschluss FROM elemente WHERE id = '10010206'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        ...
                        <p>
                            <?php
                            $query = "SELECT holzelement, daemmstoff, beleuchtung, schrauben FROM elemente WHERE id = '10010206'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
                        ...
                        <p>
                            <?php
                            $query = "SELECT fenster, tuere, baulicheveraenderungen, modulid FROM elemente WHERE id = '10010206'";
                            $result = pg_query($con, $query);
                        // Tabelle in HTML darstellen
                        echo "<table class='content-table'>\n";
