...
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Das Projektteam Studierende</h2>
        <div id="post-container">
                ...
                <div class="card">
                    ...
                    <div class="card-description">
                       <!-- <h4>Das Projektteam</h4> -->
                        ...
                        $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Das Projektteam Studierende'";
            ...
            <!--PHP CODE ENDE-->
                    ...
                    <div class="card-description">
                        ...
                        $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Steckbrief Kerstin'";
                            $result = pg_query($con, $query);
                        ...
                        ?>
                        <h4>Steckbrief Jakim</h4>
                        <p>
                        <?php
                         $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Steckbrief Jakim'";
                            $result = pg_query($con, $query);
                        ...
                        <h4>Steckbrief Janis</h4>
                        <p>
                        <?php
                         $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Steckbrief Janis'";
                            $result = pg_query($con, $query);
                        ...
                        <h4>Steckbrief Hannah</h4>
                        <p>
                        <?php
                         $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Steckbrief Hannah'";
                            $result = pg_query($con, $query);
                        ...
                        <h4>Steckbrief Moritz</h4>
                        <p>
                        <?php
                         $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Steckbrief Moritz'";
                            $result = pg_query($con, $query);
