...
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Modul "Seminarraum"</h2>
        <div id="post-container">
            <section id="blogpost">
                <div class="card">
                    <div class="card-image">
                        <img src="img/modulseminarraum.jpeg" alt="Card Image">
                    </div>
                    <div class="card-description">
                        <h3>Modulinformation</h3>
                        <p>
                        <?php
                            $host = "localhost";
                            $user = "postgres";
                            ...
                            $query = "SELECT texte FROM webapptexte WHERE ueberschrift = 'Modul Seminar'";
            ...
            <div id="sidebar">
                ...
                <p>
                    <ul>
                        <li>
                            <a href="elementseiteModell01.php">Element Wand Türe</a>
                        </li>
                        <li>
                            <a href="elementseiteModell02.php">Element Wand Fenster</a>
                        </li>
                        <li>
                            <a href="elementseiteModell03.php">Element Wand Strom</a>
                        </li>
                        <li>
                            <a href="elementseiteModell04.php">Element Decke Standard</a>
                        </li>
                        <li>
                            <a href="elementseiteModell05.php">Element Boden Standard</a>
                        </li>
                        <li>
                            <a href="elementseiteModellGestell01.php">Element Gestell 1</a>
                        </li>
