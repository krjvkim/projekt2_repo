...
<body>
    ...
    <main>
        ...
        <h2 class="page-heading">Tiny House-Siedlung Esslingen</h2>
        <div id="post-container">
            <section id="blogpost">
                <div class="card">
                    ...
                    <div class="card-description">
                        ...
                        <p>
                        <?php
                        $query = "SELECT id, siedlungsname, ort, plz, strasse, hausnummer, gruendungsdatum FROM siedlungen WHERE siedlungsname = 'Tiny House-Siedlung Esslingen'";
                        $result = pg_query($con, $query);
            ...
            <div id="sidebar">
                <h3> Weiter zu den Tinyhouses dieser Siedlung</h3>
                <p>
                    <ul>
                        <li>
                            <a href="tinyhouseseiteModell.php">Tiny House Modell</a>
                        </li>
